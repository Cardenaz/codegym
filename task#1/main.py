...
if __name__ == "__main__":
    ...
    sortfunc_list = [test_code.python_sort,quicksort_inplace,quicksort_notinplace, mergesort_inplace, mergesort_notinplace, heapsort_inplace,heapsort_notinplace]
